...
Project Genie, a generative AI system for creating interactive environments, is now integrated with nearly 20 years of Google Street View photographic data. This allows users to generate novel, interactive virtual worlds grounded in real-world locations and geographies, leveraging Earth-scale visual data to constrain generation and improve realism.
