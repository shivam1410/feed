...
Gemini Robotics ER 2 represents a major capability advancement in robotics through improved video understanding, tool orchestration, and multi-robot coordination. The system enhances the ability of robotic platforms to perceive environments, interact with tools, and coordinate collaborative actions among multiple robots. These advances expand the range of complex tasks robots can perform autonomously.
